...
tp = float(lr7_predicited3219.filter("prediction == 1.0 AND label == 1").count())
fp = float(lr7_predicited3219.filter("prediction == 1.0 AND label == 0").count())
tn = float(lr7_predicited3219.filter("prediction == 0.0 AND label == 0").count())
